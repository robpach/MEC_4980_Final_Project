...
void displayTemps()
{
  ...
  snprintf(disp, sizeof(disp), "%s|%iF", tempStr, target);
  myOLED.setFont(&QW_FONT_8X16);
  myOLED.text(0, 22, disp);
  myOLED.setFont(&QW_FONT_5X7);
  // Serial.println(disp);
  ...
  // Sine wave animation
  drawSineWave(43, 4, progress);

  // drawing the borders
  myOLED.rectangle(0, 0, 64, 48, COLOR_WHITE);
  myOLED.rectangle(0, 0, 35, 18, COLOR_WHITE);
